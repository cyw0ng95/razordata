...
// fatalKinds lists kinds that are fatal. By default, any *EC.Error not in this map is fatal.
...
// Non-*EC.Error errors are classified as KindInternal, fatal.
func Classify(err error) Classification {
	...
	// Unknown error type treated as internal fatal error
