...
type DebugStats struct {
	...
	// CTE debug counters
	CteTotalIterations atomic.Int64
	CteSeedRows        atomic.Int64
	CteArmRows         atomic.Int64
	CteMaxItersReached atomic.Int64
}
...
func (s *DebugStats) Snapshot() map[string]int64 {
	return map[string]int64{
		...
		"cte_total_iterations": s.CteTotalIterations.Load(),
		"cte_seed_rows":        s.CteSeedRows.Load(),
		"cte_arm_rows":         s.CteArmRows.Load(),
		"cte_max_iters_reached": s.CteMaxItersReached.Load(),
	}
}
