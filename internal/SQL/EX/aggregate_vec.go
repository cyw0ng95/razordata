...
func NewVectorizedCount(child *VectorizedSeqScan) *VectorizedCount {
...
func NewVectorizedSum(child *VectorizedSeqScan, colIdx int) *VectorizedSum {
...
func NewVectorizedAvg(child *VectorizedSeqScan, colIdx int) *VectorizedAvg {
...
func NewVectorizedMin(child *VectorizedSeqScan, colIdx int) *VectorizedMin {
...
func NewVectorizedMax(child *VectorizedSeqScan, colIdx int) *VectorizedMax {
