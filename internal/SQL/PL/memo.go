...
// Memo caches plans keyed by AST fingerprint.
type Memo struct {
...
func NewMemo() *Memo {
	return &Memo{plans: make(map[string]Plan)}
}

// Get returns a cached plan and whether it was present.
...
// SerializeKey returns a stable SHA-256 fingerprint of an AST.
