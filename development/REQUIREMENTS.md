...
| REQ000144 | SQL | SIMD vectorized execution (batch processing, manual unrolling, selection vectors) | critical | XL | REQ000149 | SQL/EX: batch.go, eval_vec.go, operators_vec.go (iter-19 Phase 1 v0.14.0) |
...
| REQ000149 | SQL | Columnar batch memory management (sync.Pool for 1024-row batches) | high | M | none | SQL/EX: batch.go (iter-19 Phase 1 v0.14.0) foundation for REQ000144 |
| REQ000157 | SQL | Expression evaluation SIMD acceleration (batch predicate evaluation) | high | M | REQ000149 | SQL/EX: eval_vec.go (iter-19 Phase 1 v0.14.0) |
| REQ000173 | SQL/EX | SIMD vectorized operators (columnar batch layout, selection vectors, manual unrolling) | critical | XL | REQ000144+REQ000157 | Consolidated into REQ000144 implementation (iter-19 Phase 1 v0.14.0) |
