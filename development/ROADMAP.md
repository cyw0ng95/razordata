...
| **v0.20.0** | **Statistics & Data Integrity** (iter-23 phase 1). ANALYZE executor, histogram-based selectivity, PRAGMA integrity_check, VACUUM, backup/restore API, razor CLI, WAL checksum verification. Target: ~4,000 LOC. |
