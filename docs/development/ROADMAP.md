...
| 27 | Maturity Push | Phases 1-5 (25 REQs, v0.27.0): SLT 42/42, trigger parser, generated cols, SST dict compression, WAL columnar, rate-limited compactor, sub-compaction, compaction style, W-TinyLFU, off-heap pool, escape hints, QSBR, FROM-subquery parser fix, real goroutine ID, epoch background goroutine, reclaim pool, parallel WAL replay, 8-wide SIMD EvalBatch + CPU detection, radix hash join, columnar SST/PAX. Phase 6 (6 REQs, v0.27.1/v0.28.0): REQ000074 IndexScan real seek, REQ000295 io_uring, REQ000296 Direct I/O + fixed-fd, REQ000301 async fsync, REQ000307 MV-OCC timestamp ordering, REQ000309 NUMA-aware placement | `SQL/PS`, `SQL/EX`, `ENG/LS`, `WAL/WR`, `MEM/BF`, `MEM/OF`, `TXN/MV`, `TXN/LC`, `FIL/FS`, `FIL/IO` (new) | done (v0.27.0); Phase 6 in progress |
