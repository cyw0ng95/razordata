...
var includedCases = []includedCase{
	...
	{Label: "rsel1", Path: "random/select/slt_good_1", Timeout: 120},
	{Label: "rsel123", Path: "random/select/slt_good_123", Timeout: 120},
	{Label: "rsel124", Path: "random/select/slt_good_124", Timeout: 120},
